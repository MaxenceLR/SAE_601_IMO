...
if os.path.exists(fichier_local):
    try:
        ...
        print("Fichier corrompu détecté (probablement une erreur 404). Suppression en cours...")
        os.remove(fichier_local)

if not os.path.exists(fichier_local):
    print("Téléchargement des polygones géographiques (cela peut prendre quelques secondes)...")
...
print("Création de la table DIM_GEOGRAPHIE...")
